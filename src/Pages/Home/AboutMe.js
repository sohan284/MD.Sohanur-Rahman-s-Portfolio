...
const AboutMe = () => {
    return (
        <div className='container mb-10 mx-auto'>
            <div data-aos="fade-up-left" className='  skills shadow-xl p-3 rounded-md'>
                    ...
                    <div data-aos="zoom-in">
                        ...
                        <div data-aos="zoom-in"> <p className='text-accent text-xl m-5'>
                          <p className='font-bold text-3xl text-center'>MD.Sohanur Rahman Sohan 
                              </p>
                              <p className='font-semibold text-xl text-center'>Department of Software Engineering </p><p className='font-thin text-center text-lg'>
                              (Expected Graduation Year, 2022)</p><p className='font-semibold text-xl text-center '>Daffodil International University </p>
                        </p></div>
            ...
            <div className='grid grid-cols-1 gap-5'>
                <div data-aos="fade-up-right" className='border bg-[#c4c4c41a]   p-3 rounded-md'>
                    <h1 className='text-4xl mb-2 text-center uppercase text-accent font-semibold '>Skills</h1> <hr />
                    <div className='ml-5 mt-5 flex justify-evenly flex-col lg:flex-row sm:flex-row'>
                        <div data-aos="fade-up-right" className='flex my-2'>
                        ...
                        <div data-aos="fade-up-left" className='flex my-2'>
