      ...
      <div class="hero-content flex-col lg:flex-row-reverse">
        <div data-aos="fade-up">
          <img
            ...
            class="max-w-sm rounded shadow-2xl"
          />
        </div>
        <div data-aos="fade-up" className="ml-20">
          ...
          <div data-aos="fade-up" className="flex footerIcon">
            ...
            <a
              className="link link-hover border-2 rounded-full"
            ...
            <a
              className="link link-hover ml-1 border-2 rounded-full"
